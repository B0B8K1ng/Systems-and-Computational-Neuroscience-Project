...
parser.add_argument('-data-dir', metavar='DIR', default="/mnt/nas/algorithm/cong.wang/projects/spikingformer/data/imagenet/dataset",
...
parser.add_argument('--resume',
                    default='/mnt/nas/algorithm/cong.wang/projects/spikingformer/checkpoint-284.pth.tar',
...
def main():
    ...
    print("split_bn is:", args.split_bn)
    if args.split_bn:
    ...
    print("data_dir is:", args.data_dir)
    print("train_split is:", args.train_split)
    print("args.batch_size is:", args.batch_size)
    print("args.epoch_repeats is:", args.epoch_repeats)
    # create the train and eval datasets
    dataset_train = create_dataset(
        args.dataset,
        root=args.data_dir, split=args.train_split, is_training=True,
        batch_size=args.batch_size, repeats=args.epoch_repeats)
    print("Training mission finished: creating dataset")
    dataset_eval = create_dataset(
        args.dataset, root=args.data_dir, split=args.val_split, is_training=False, batch_size=args.batch_size)
    print("Test mission finished: creating dataset")
